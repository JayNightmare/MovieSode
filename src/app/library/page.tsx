                ...
                <div className="relative flex flex-wrap items-center justify-between gap-6">
                    <div className="space-y-2">
                        ...
                        <p className="max-w-2xl text-sm text-zinc-400">
                            Upload your own movies, split them into a custom
                            session lengths, and pick up where you left off.
                        </p>
                    </div>
                    <Link
                        href="/movie/new"
                    ...
                    {movies.length > 0 ? (
                        <span className="rounded-full border border-white/10 bg-white/5 px-3 py-1 font-medium">
                            ...
                            <span className="text-zinc-400">
                                {movies.reduce(
                                    (total, movie) => total + movie.length,
                                    0
                                ) / movies.length}{" "}
                                minutes
                            </span>
            ...
            <section className="space-y-4">
                ...
                {movies.length === 0 && (
                    <div className="rounded-2xl border border-white/5 bg-zinc-950/80 p-6 text-zinc-300 shadow-inner shadow-black/40">
                        No movies yet. Add your first upload to start cutting it
                        into episodes.
                    </div>
                )}
            </section>
