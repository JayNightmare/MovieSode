            ...
            <section className="relative overflow-hidden rounded-3xl border border-white/5 bg-gradient-to-br from-zinc-950 via-zinc-900 to-black p-6 shadow-[0_25px_70px_-40px_rgba(0,0,0,0.9)]">
                ...
                <div className="relative space-y-2">
                    ...
                    <p className="max-w-2xl text-sm text-zinc-400">
                        Drop in a movie you own or point to an existing file
                        path. We&apos;ll keep everything on your computer, kick
                        off processing automatically, and split it into
                        episodes.
                    </p>
                </div>
            </section>
            ...
            <section className="grid gap-6 lg:grid-cols-[2fr,1fr]">
                    ...
                    <div className="grid gap-4 sm:grid-cols-2">
                        ...
                        <div className="space-y-2">
                            ...
                            <p className="rounded-xl border border-white/5 bg-white/5 px-3 py-2 text-xs text-zinc-300">
                                Uses your filesystem: uploads stay local,
                                episodes go to{" "}
                        ...
                        <div className="flex flex-col gap-4 rounded-2xl border border-dashed border-white/10 bg-zinc-900/50 p-6 transition hover:bg-zinc-900/80">
                            ...
                            {localPath ? (
                                ...
                                <div className="flex flex-wrap gap-3">
                                    ...
                                    {/* Fallback Standard Input (hidden but functional if needed, or secondary) */}
                                    <div className="relative hidden">
                                        <input
                                            ...
                                            onChange={(e) => {
                                                if (e.target.files?.[0]) {
                                                    // If we can't get the path (browser), we rely on upload
                                                    // If we are in electron but user used this input, 'path' property might be available on File object in Electron
                                                    // But safely, let's just use standard upload if they use this input.
                                                }
                                            }}
                                        />
                                        <button
                                            type="button"
                                            className="pointer-events-none inline-flex items-center gap-2 rounded-lg border border-white/10 px-4 py-2 text-sm font-medium text-zinc-300"
                                        >
                                            Browse...
                                        </button>
                                    </div>
                ...
                <div className="space-y-4 rounded-2xl border border-white/5 bg-gradient-to-b from-zinc-900 to-zinc-950 p-6 text-sm text-zinc-300 shadow-inner shadow-black/40">
                    ...
                    <ul className="space-y-2 text-sm text-zinc-400">
                        <li>
                            1) If you upload, the file is written to your
                            machine (default:
                            <code className="bg-zinc-900/70 px-1">
                                ~/Documents/MovieSode/Uploads
                            </code>
                            ). If you provide a path, it is used directly (no
                            copy).
                        </li>
                        <li>
                            ...
                            , then the background worker starts immediately.
                        </li>
                        <li>
                            3) ffmpeg cuts it into custom session length
                            episodes saved in{" "}
                            <code className="bg-zinc-900/70 px-1">
                                ~/Documents/MovieSode/Episodes
                            </code>
